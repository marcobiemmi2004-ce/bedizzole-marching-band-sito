...
(function () {
  ...
  const DICT = {
    ...
    en: {
      ...
      'chisiamo.intro': 'Since 1880 we’ve brought music to the streets of Bedizzole. Today we’re a marching show band of 47 people between musicians, color guard and staff, with an Academy for the youngest and a motto that represents us: <strong>One band, one sound.</strong>',
