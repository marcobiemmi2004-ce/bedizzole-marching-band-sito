...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'accademia.boxtitle': 'Pagina in costruzione',
      'accademia.boxtext': 'Qui spiegheremo nel dettaglio il percorso per chi parte da zero: quali strumenti si possono imparare, se ci sono costi/quote di iscrizione, età minima, quando iniziano i corsi, chi insegna e come si passa poi in banda. Dammi questi dettagli e costruisco il percorso passo-passo con un modulo di iscrizione.',
    ...
    en: {
      ...
      'accademia.boxtitle': 'Page under construction',
      'accademia.boxtext': 'Here we’ll explain in detail the path for those starting from scratch: which instruments can be learned, whether there are enrolment fees, minimum age, when courses start, who teaches, and how you then join the band. Send me these details and I’ll build the step-by-step path with a sign-up form.',
