...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'storia.y3b.p': 'Cresciuto nel vivaio del marching fin da piccolo, Matteo Rebecchi viene eletto presidente della Bedizzole Marching Band, carica che ricopre tuttora.',
      'storia.y3c.h3': 'Parte il progetto di crescita musicale',
      'storia.y3c.p': 'Sotto la guida del maestro Nicola Orsato, oggi Band Director e Drum Major, prende il via un progetto dedicato alla crescita musicale del gruppo.',
    ...
    en: {
      ...
      'storia.y3b.p': 'Having grown up in the marching world since childhood, Matteo Rebecchi is elected president of the Bedizzole Marching Band, a role he still holds today.',
      'storia.y3c.h3': 'The musical growth project begins',
      'storia.y3c.p': 'Under the guidance of maestro Nicola Orsato, today Band Director and Drum Major, a project dedicated to the group\'s musical growth gets underway.',
