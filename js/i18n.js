...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'media.vinay.p': 'Quattro giorni di festa in Francia, tra sfilate e spettacoli ufficiali insieme a formazioni da tutta Europa — ma non solo: tra una tappa e l\'altra sono nate anche jam session improvvisate con gli altri gruppi, nate solo per il gusto di suonare insieme e fare gruppo.',
    ...
    en: {
      ...
      'media.vinay.p': 'Four days of celebration in France, official parades and shows alongside bands from across Europe — but not only that: between one stop and the next, impromptu jam sessions broke out with the other groups, born purely for the joy of playing together and bonding as a group.',
