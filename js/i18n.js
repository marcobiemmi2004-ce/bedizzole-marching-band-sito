...
(function () {
  ...
  const DICT = {
    it: {
      ...
      'chisiamo.intro': 'Dal 1880 portiamo musica per le strade di Bedizzole. Oggi siamo una marching show band di 47 persone tra musicisti, color guard e staff, con un’Accademia per i più giovani e un motto che ci rappresenta: <strong>Una banda, un sound.</strong>',
    ...
    en: {
      ...
      'chisiamo.intro': 'Since 1880 we’ve brought music to the streets of Bedizzole. Today we’re a marching show band of 47 people between musicians, color guard and staff, alongside the Bedizzole Junior Marching Band and the Academy for the youngest, with a motto that represents us: <strong>One band, one sound.</strong>',
